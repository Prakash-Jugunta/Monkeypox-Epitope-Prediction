...
# Step 6: Cross-Validation and Hyperparameter Tuning with LightGBM
...
grid_search = GridSearchCV(
    lgb_model, param_grid, cv=3, scoring='roc_auc', verbose=1
)
...
plt.title('Original MPOX data - LightGBM')
